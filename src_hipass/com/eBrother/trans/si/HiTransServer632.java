...
import com.eBrother.trans.kafka.KafkaConst;
...
public class HiTransServer632  implements ProtocolHandler, MBeanRegistration, KafkaConst {

	 //   protected static org.apache.juli.logging.Log log
	 //       = org.apache.juli.logging.LogFactory.getLog(TransProtocol.class);
	protected static Logger log = Logger.getLogger(HiTransServer632.class.getName());
	// ------------------------------------------------------------ Constructor

    public HiTransServer632() {
    ...
    static boolean _connectchecked = false;
    ...
    public void init() throws Exception {
        ...
        try {
        	testcon = new HiTransConnectCheker();
        	connectcheck = new Thread(testcon, "testcon");
    ...
    synchronized public void start() throws Exception {
		...
		if(_connectchecked == false) {
			connectcheck.start();
			_connectchecked = true;
		}
    ...
    protected static class TransProtocolHandler implements Handler {
        ...
        protected HiTransServer632 proto;
        protected AtomicLong registerCount = new AtomicLong(0);
        protected RequestGroupInfo global = new RequestGroupInfo();

        protected ConcurrentLinkedQueue<HiTransWorker632> recycledProcessors = 
            new ConcurrentLinkedQueue<HiTransWorker632>() {
            protected AtomicInteger size = new AtomicInteger(0);
            public boolean offer(HiTransWorker632 processor) {
            ...
            public HiTransWorker632 poll() {
                HiTransWorker632 result = super.poll();
                if ( result != null ) {
        ...
        TransProtocolHandler(HiTransServer632 proto) {
            this.proto = proto;
        }

        public boolean process(Socket socket) {

            HiTransWorker632 processor = recycledProcessors.poll();
            ...
            // above.
                ...
                HiTransServer632.log.error ("TransProtocol.proto.error", e);
            } finally {
        ...
        protected HiTransWorker632 createProcessor() {
        	
        	// _kafka = new KafkaProducerManager2 ( _config );
        	
            HiTransWorker632 processor =
                new HiTransWorker632(proto.maxHttpHeaderSize, proto.endpoint,  _config );
        ...
        protected void register(HiTransWorker632 processor) {
        ...
        protected void unregister(HiTransWorker632 processor) {
            if (proto.getDomain() != null) {
                synchronized (this) {
                    try {
                        RequestInfo rp = processor.getRequest().getRequestProcessor();
