...
<table border="1">
<tr>
<td> 전문 Type </td><td><input type="text" name="callType" value="<%= callType %>" /> </td>
</tr>
<tr>
...
<tr>
<td> 차량제원정보 </td><td> <%= plresp.getCsData () %></td>
</tr>
...
mv ./backup/*20201023* ./in

cd ~/apiservice/pl-trans-server/bin
...
<tr>
<td> PL search </td><td> ** 소형차량정보 처리 여부 미확정 - 차량제원정보에서 차종 ( 1 ~ 6 ) 에 없으면, PL 로 처리  <%= plresp.getPlData () %></td>
</tr>
