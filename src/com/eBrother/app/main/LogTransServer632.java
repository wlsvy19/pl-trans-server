...
public class LogTransServer632  implements ProtocolHandler, MBeanRegistration {

	 //   protected static org.apache.juli.logging.Log log
	 //       = org.apache.juli.logging.LogFactory.getLog(TransProtocol.class);
	protected static Logger log = Logger.getLogger(LogTransServer632.class.getName());
	// ------------------------------------------------------------ Constructor

	static ParserWorker m_parser = null; // = new ParserWorker ();

    public LogTransServer632() {
    ...
    protected static class TransProtocolHandler implements Handler {
        ...
        protected LogTransServer632 proto;
        ...
        TransProtocolHandler(LogTransServer632 proto) {
            this.proto = proto;
        }
        ...
        public boolean process(Socket socket) {
            ...
            // above.
                ...
                LogTransServer632.log.error ("TransProtocol.proto.error", e);
            } finally {
